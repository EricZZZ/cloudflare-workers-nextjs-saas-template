...
export const SITE_URL = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://sass.ericzzz.com"
export const GITHUB_REPO_URL = "https://github.com/EricZZZ/cloudflare-workers-nextjs-saas-template"
